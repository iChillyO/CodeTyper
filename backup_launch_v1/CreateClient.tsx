...
export default function CreateClient() {
    ...
    const [code, setCode] = useState('console.log("Hello, Gaza!");');
    ...
    const calculateDuration = (rawCodeStr: string, currentSpeedMs: number) => {
        ...
        const totalTimeMs = baseTypingTimeMs + extraPauseTimeMs + 2500; // Stronger ending hold
    ...
    const handleRender = async () => {
        ...
        try {
            ...
            if (!res.ok) {
                ...
                setRenderMessage({
                    text: isLimitError
                        ? `${data.error} Please upgrade to continue.`
            ...
            <div className="pt-20 pb-32 lg:pb-8 px-4 lg:px-6 max-w-[1700px] mx-auto">
                ...
                <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start justify-center">
                    ...
                    <div className={`flex-[1.4] w-full lg:sticky lg:top-24 ${activeTab !== 'preview' ? 'hidden lg:block' : 'block'}`}>
                        <Card className="overflow-hidden border-white/10 shadow-[0_40px_100px_rgba(0,0,0,0.5),0_0_80px_rgba(59,130,246,0.12)] bg-black/40 backdrop-blur-3xl ring-1 ring-white/10 group">
                            <CardHeader className="flex flex-row items-center justify-between bg-white/[0.03] px-8 py-5 border-b border-white/5">
                                <div className="flex items-center gap-3">
                                    ...
                                    <CardTitle className="text-xl tracking-tight font-black">Video Preview</CardTitle>
                                </div>
                            ...
                            <CardContent className="p-0 bg-black aspect-video flex items-center justify-center overflow-hidden relative">
                                <Player
                            ...
                            <CardHeader className="py-4">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <CardTitle className="text-sm uppercase tracking-widest text-slate-400">Source Code</CardTitle>
                                    </div>
